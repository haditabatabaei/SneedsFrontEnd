<template>
    <section class="package-form-wrapper">
        <package-staging current-stage-value="fillout" />
            ...
            async editForm() {
                ...
                if (!this.formIsInvalid) {
                    ...
                    try {
                        ...
                        this.$router.push('/user/userpackages?fromstaging=true');
                    } catch (e) {
                        this.$notify({
                            group: 'notif',
                            type: 'error',
